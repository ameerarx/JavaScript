...
function Dope(command){
    ...
    function addContact(){
        ...
        if(phone_book.hasOwnProperty(name)==true){
...
Dope("ADD Ivan 555-10-01,555-10-03");
Dope('ADD Ivan 555-10-02');

Dope('ADD Alex 555-20-01');

console.log( Dope("SHOW"))